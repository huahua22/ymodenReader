package com.xwr.ymodenreader.ymoden;
...
public class YModem implements FileStreamThread.DataRaderListener {
  ...
  private static final byte ACK = 0x06; /* ACKnowlege *///回应
  private static final byte NAK = 0x15; /* Negative AcKnowlege *///没回应
  ...
  private YModem(Context context, String filePath,
    ...
    Log.i("xwr", filePath + ";" + fileNameString);
