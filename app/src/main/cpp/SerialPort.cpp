...
native_open(JNIEnv *env, jobject instance, jstring path,
            jint baudrate) {
    int fd;
    speed_t speed;
...
native_close(JNIEnv *env, jobject instance) {
...
static int registerNatives(JNIEnv *env) {
    const char *kClassName = "com/xwr/ymodenreader/SerialPort"; //指定要注册的类
